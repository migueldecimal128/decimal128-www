...
26401.101 review edition (SDK 11.0.100-rc.1.26401.101).
...
Cohort is UNCHANGED from the 26380.103 edition: System.Decimal stays retired and the
...
xRcsbid9, which the 26380.103 edition's methodology deliberately avoided. Section 3 of
the page says so explicitly; do not silently present those rows as same-session.

Usage (run from this directory):
    gen_bench_net11_rc1_26401_101.py --emit  <id>        print one table block to stdout
    gen_bench_net11_rc1_26401_101.py --splice [FILE]     splice all blocks into FILE in place
    gen_bench_net11_rc1_26401_101.py --check  [FILE]     diff each block vs the block in FILE
FILE defaults to the review page (../reviews/dotnet/net11-rc1-26401.101.md).
"""
import json, glob, os, re, sys

HERE   = os.path.dirname(os.path.abspath(__file__))
TARGET = os.path.normpath(os.path.join(HERE, "..", "reviews", "dotnet", "net11-rc1-26401.101.md"))
